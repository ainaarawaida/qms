<?php
	...
	if($_POST['no_id'] == ""){
		...
		$conn->query("INSERT INTO `ncr` VALUE('', '$jabatan_unit', '$staff_no', '$no_audit', '$tarikh_audit', '$no_ncr', '$iso', '$dokumen', '$keperluan', '$penemuan', '$bukti_objektif', '$ketakakuran', '$pembetulan', '$tindakan', 'done')");
		echo $conn->insert_id;
	}else{
		$jabatan_unit = $_POST['jabatan_unit'];
		$staff_no = $_POST['staff_no'];
