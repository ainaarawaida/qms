...
<div id="Menu" class="tabcontent" style="height: 600px">
  <h3>TINDAKAN SUSULAN</h3>
  <table cellpadding="5px">
    <tr>
      <td>
        <div>
    <a class="btn btn-sm btn-warning" href="listNcr.php" role="button">Kemaskini NCR</a>
    <a class="btn btn-sm btn-warning" href="listNcrDihantar.php" role="button">NCR Dihantar</a>
    <a class="btn btn-sm btn-warning" href="ofi.php" role="button">Borang OFI</a>
    <a class="btn btn-sm btn-warning" href="listOfi.php" role="button">Borang OFI Dihantar</a>
  </div>
      </td>
    </tr>
  </table>
