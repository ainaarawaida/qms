...
<div id="Menu" class="tabcontent" style="height: 600px">
  ...
  <div align="justify">
    <br>
              <ul class="style41">
                <li>Laman ini adalah laman utama bagi pentadbir Sistem Pengurusan Audit.</li>
                <br>
                <li>Bagi pendaftaran atau tambah juruaudit, pentadbir perlu klik pada menu <strong>'Tambah Juruaudit'</strong>.</li>
               <br>
                <li>Bagi menyemak maklumat juruaudit, pentadbir perlu pada menu <strong>'Profil Juruaudit'</strong>.</li>
               <br>
                <li>Bagi menyemak atau mengemaskini jadual audit, pentadbir perlu klik pada menu <strong>'Kemaskini Jadual Audit'</strong>.</li>
                <br>
                <li>Bagi melihat paparan data analitik audit, pentadbir perlu klik pada menu <strong>'Papar Data Analitik Audit'</strong>.</li>
               <br>
                <li>Bagi menyemak laporan audit, pentadbir perlu klik pada menu <strong>'Laporan Audit'</strong>.</li>
              </ul>
              <p>&nbsp;</p>
  </div>
