...
if(isset($_REQUEST['btn_insert']))
{
  try
  {
    ...
    else if($type=="image/jpg" || $type=='image/jpeg' || $type=='image/png' || $type=='application/pdf') //check file extension
    { 
    ...
    {
      $errorMsg="Upload JPG , JPEG , PNG & PDF File Formate.....CHECK FILE EXTENSION"; //error message file extension
    }
    
    if(!isset($errorMsg))
    {
      $insert_stmt=$conn->prepare('INSERT INTO tbl_file(name,image) VALUES(:fname,:fimage)'); //sql insert query          
