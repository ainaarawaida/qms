...
<div id="Menu" class="tabcontent" style="height: 600px">
  ...
  <div align="justify">
    <br>
              <ul class="style41">
                <li>Laman ini adalah laman utama bagi ketua juruaudit Sistem Pengurusan Audit.</li>
                <br>
                <li>Bagi menyemak maklumat penemuan, ketua juruaudit perlu klik pada menu <strong>'Semak Maklumat Penemuan'</strong>.</li>
               <br>
                <li>agi menyemak maklumat tindakan, ketua juruaudit perlu klik pada menu <strong>'Semak Maklumat Tindakan'</strong>.</li>
               <br>
                <li>Bagi menyemak atau mengemaskini jadual audit, ketua juruaudit perlu klik pada menu <strong>'Jadual Audit'</strong>.</li>
                <br>
                <li>Bagi melihat paparan data analitik audit, ketua juruaudit perlu klik pada menu <strong>'Papar Data Analitik Audit'</strong>.</li>
               <br>
                <li>Bagi menyemak laporan audit, ketua juruaudit perlu klik pada menu <strong>'Laporan Audit'</strong>.</li>
              </ul>
              <p>&nbsp;</p>
  </div>
</div>
