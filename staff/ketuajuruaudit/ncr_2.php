...
<div id="Menu" class="tabcontent" style="height: 800px">
  ...
  <div class="panel-body">
    ...
    <tr>
      <th>No. Audit : <input type="text" name="no_audit" class="form-control" id="no_audit"></th>
      <th>Tarikh Audit: <input type="text" name="tarikh_audit" class="form-control" id="tarikh_audit" size="10" maxlength="10" value="" />
          
          <img src="cal.gif" onclick="javascript:NewCssCal('tarikh_audit','yyyyMMdd','arrow',false,'24','','future')" style="cursor:pointer"/>
        </th>
      <th>No. NCR: <input type="text" name="no_ncr"  class="form-control" id="no_ncr" ></th>
      
    </tr>
    <tr>
      <td>MS ISO 9001: <input type="text" name="iso" class="form-control" id="iso" ></td>
      <td>Pusat Pengajian /Jabatan / Unit yang diaudit: <input name="jabatan_unit" type="text" class="form-control" id="jabatan_unit" ></td>
      <td>Dokumen yang diaudit yang menimbulkan ketakakuran: <input name="dokumen" type="text" class="form-control" id="dokumen"></td>
    </tr>
    <tr>
      <th colspan="4">Ketakakuran yang ditemui</th></tr>
    <tr>
      <td>Keperluan:</td>
      <td colspan="3"><textarea name="keperluan" id="keperluan" style="resize:none;" cols="50" rows="5" placeholder="" class="form-control" required></textarea></td>
    </tr>
    <tr>
      <td>Penemuan:</td>
      <td colspan="3"><textarea name="penemuan" id="penemuan" style="resize:none;" cols="50" rows="5" placeholder="" class="form-control" required></textarea></td>
    </tr>
    <tr>
      <td>Bukti Objektif:</td>
      <td colspan="3"><textarea name="bukti_objektif" id="bukti_objektif" style="resize:none;" cols="50" rows="5" placeholder="" class="form-control" required></textarea></td>
    </tr>
