...
if (isset($_POST['tambah'])) {
  ...
  try {
    ...
    $stmt = $conn->prepare("INSERT INTO laporan (fail_rujukan, klien, alamat_audit, tarikh_audit, tempoh, standard, rujukan, skop, bil_ncr, bil_kehadiran, bil_ofi, pelan_audit, aktiviti_klien, staff_name, peranan, perubahan, amalan_terbaik, penilaian, rumusan, cadangan ) VALUES(:fail_rujukan, :klien, :alamat_audit, :tarikh_audit, :tempoh, :standard, :rujukan, :skop, :bil_ncr, :bil_kehadiran, :bil_ofi, :pelan_audit,:aktiviti_klien, :staff_name, :peranan, :perubahan, :amalan_terbaik, :penilaian, :rumusan, :cadangan)");
