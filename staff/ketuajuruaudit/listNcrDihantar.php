    ...
    <tr>
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM ncr WHERE status = 'post' LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td>
          ...
          <a href="updateNcr.php?edit=<?php echo $readrow['no_id']; ?>" class="btn btn-success btn-xs" role="button">Lihat</a>
