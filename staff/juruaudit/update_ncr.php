<?php
	...
	if($_POST['no_id'] == ""){
		...
		$conn->query("INSERT INTO `ncr` VALUE('', '$staff_no', '$no_audit', '$tarikh_audit', '$no_ncr', '$iso', '$jabatan_unit', '$dokumen', '$keperluan', '$penemuan', '$bukti_objektif', '$ketakakuran', '$pembetulan', '$tindakan', 'draf', '$tindakankesan', '$tindakantakkesan', '$selesai', '$belumselesai')");
		echo $conn->insert_id;
	}else{
		$staff_no = $_POST['staff_no'];
		$no_audit = $_POST['no_audit'];
