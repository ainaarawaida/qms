   ...
   <div class="panel-body">
                            <div class="table-responsive">
                                <table width="15px" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                  <?php
                  $select_stmt=$conn->prepare("SELECT * FROM tbl_file");  //sql select query
                  $select_stmt->execute();
                  ...
                  ?>
                                        <tr>
                                            ...
                                            <td><a href="uploads/<?php echo $row['image']; ?>" class="btn btn-success btn-xs" role="button" download="<?php echo $row['image']; ?>">
            Muat Turun
        </a></td>
                                            <td>
