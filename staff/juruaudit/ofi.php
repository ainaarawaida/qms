...
<div id="Menu" class="tabcontent" style="height: 800px">
  ...
  <div class="panel-body">
    ...
    ?>
      ...
      <tr class="datatable" >
        ...
        <td><input readonly type="text" value="<?php echo isset($rowdata['susulan'][$key]) ? $rowdata['susulan'][$key] : '' ; ?>" name="susulan[<?php echo $key ; ?>]"></td>
        <td><input readonly type="date" value="<?php echo isset($rowdata['tarikh_tindakan'][$key]) ? $rowdata['tarikh_tindakan'][$key] : '' ; ?>" name="tarikh_tindakan[<?php echo $key ; ?>]"></td>
      </tr>
    <?php 
      }}
      }else{ 
    ...
    <tr class="datatable" >
      ...
      <td><input readonly type="text" value="" name="susulan[1]"></td>
      <td><input readonly type="date" value="" name="tarikh_tindakan[1]"></td>
    </tr>
    <?php } ?>
    <tr  id="datatable">
  ...
  <?php if(!isset($_GET['ofi_id']) OR (isset($_GET['ofi_id']) && isset($row['user_type']) &&  $row['user_type'] != 'ketuajuruaudit')) { ?>
