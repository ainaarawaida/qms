...
<div id="Menu" class="tabcontent" style="height: 800px">
  ...
  <div class="panel-body">
    ...
    <tr>
      <th>No. Audit : <input type="text" class="form-control" id="no_audit" required></th>
      <th>Tarikh Audit: <input type="text" class="form-control" id="tarikh_audit" size="10" maxlength="10" value="" required/>
          
          <img src="cal.gif" onclick="javascript:NewCssCal('tarikh_audit','yyyyMMdd','arrow',false,'24','','future')" style="cursor:pointer"/>
        </th>
      <th>No. NCR: <input type="text" class="form-control" id="no_ncr" required></th>
      
    </tr>
    <tr>
      <td>MS ISO 9001: <input type="text" class="form-control" id="iso" required></td>
      <td>Pusat Pengajian /Jabatan / Unit yang diaudit: <input type="text" class="form-control" id="jabatan_unit" required></td>
      <td>Dokumen yang diaudit yang menimbulkan ketakakuran: <input type="text" class="form-control" id="dokumen" required></td>
    </tr>
    <tr>
