...
<div id="Menu" class="tabcontent" style="height: 600px">
  ...
  <div align="justify">
    <br>
              <ul class="style41">
                <li>Laman ini adalah laman utama bagi juruaudit Sistem Pengurusan Audit.</li>
                <br>
                <li>Bagi mengemaskini profil, juruaudit perlu pada menu <strong>'Profil Diri'</strong>.</li>
                <br>
                <li>Bagi menyemak maklumat penemuan, juruaudit perlu klik pada menu <strong>'Semak Maklumat Penemuan'</strong>.</li>
                <br>
                <li>Bagi menyemak jadual audit, juruaudit perlu klik pada menu <strong>'Jadual Audit'</strong>.</li>
               <br>
                <li>Bagi menyemak laporan audit, juruaudit perlu klik pada menu <strong>'Laporan Audit'</strong>.</li>
              </ul>
              <p>&nbsp;</p>
  </div>
</div>
