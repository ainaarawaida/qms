$(document).ready(function(){
	...
	$('#save').on('click', function(){
		...
		var ketakakuran = $('#ketakakuran').val();
		var pembetulan = $('#pembetulan').val();
		var tindakan = $('#tindakan').val();
		var tindakankesan = $('#tindakankesan').val();
		var tindakantakkesan = $('#tindakantakkesan').val();
		var selesai = $('#selesai').val();
		var belumselesai = $('#belumselesai').val();
		var no_id = $('#no_id').val();
			...
			if( staff_no != "" ){
				...
				url: 'save_ncr.php',
				type: 'POST',
				data: {staff_no: staff_no, no_audit: no_audit, tarikh_audit: tarikh_audit, no_ncr: no_ncr, iso: iso, jabatan_unit: jabatan_unit, dokumen: dokumen, keperluan: keperluan, penemuan: penemuan, bukti_objektif: bukti_objektif, ketakakuran: ketakakuran, pembetulan: pembetulan, tindakan: tindakan, tindakankesan: tindakankesan, tindakantakkesan: tindakantakkesan, selesai: selesai, belumselesai: belumselesai, no_id: no_id},
				success: function(){
					$('#staff_no').val('');
					$('#no_audit').val('');
					$('#tarikh_audit').val('');
