  ...
  <table width="9px" class="table table-striped table-bordered">
    <tr>
      ...
      try {
        ...
        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
          $stmt = $conn->prepare("SELECT * FROM ncr WHERE staff_no = '$uid' AND status = 'done' LIMIT $start_from, $per_page");
        $stmt->execute();
      ...
      <tr>
        ...
        <td>
          <a href="ncr_susulan.php?no_id=<?php echo $readrow['no_id']; ?>" class="btn btn-success btn-xs" role="button">Lihat</a>
        </td>
      </tr>
      <?php
      }
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          <?php } else { ?>
            <li><a href="susulan.php?page=<?php echo $page-1 ?>" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
          <?php
          }
          for ($i=1; $i<=$total_pages; $i++)
            if ($i == $page)
              echo "<li class=\"active\"><a href=\"susulan.php?page=$i\">$i</a></li>";
            else
              echo "<li><a href=\"susulan.php?page=$i\">$i</a></li>";
          ?>
